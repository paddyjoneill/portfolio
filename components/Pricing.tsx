const Pricing = () => {
    const props = {
        standard: {
            title: 'Standard',
            items: ['Website', 'Email set up', 'Domain name set up', 'SEO'],
            price: '£150',
        },
    };
        ...
        <section className="bg-gray-100 py-8" id="pricing">
            <div className="container mx-auto px-2 pt-4 pb-12 text-gray-800">
                ...
                <div className="flex flex-col sm:flex-row justify-center pt-12 my-12 sm:my-4">
                    ...
                    {/*    </div>*/}
                    {/*</div>*/}
                    <div className="flex flex-col w-5/6 lg:w-1/2 mx-auto lg:mx-0 rounded-lg bg-white mt-4 sm:-mt-6 shadow-lg z-10">
                        <div className="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
                            <div className="w-full p-8 text-3xl font-bold text-center">{props.standard.title}</div>
                            <div className="h-1 w-full gradient my-0 py-0 rounded-t"></div>
                            <ul className="w-full text-center text-base font-bold">
                                {props.standard.items.map((i) => (
